...
| A8 | 🔴 **`library_borrow` 借阅册数与借期口径冲突**：图书馆官网**两处独立来源**（《借书规则》2022-03-03、《常见问题》表格与文字）都是「学生 **30 册 / 借期 60 天**，续借 30 天」，语料却写「本科生 10 册 / 30 天、研究生 15 册 / 60 天」（本校为职业本科，出现「研究生借阅规则」本身就可疑）；另语料写「超期罚金 0.1 元/册/天、欠费累计超 5 元停借」，而官网《违章处罚条例》只有「逾期未还，计算机将自动停止借书」，**通篇无罚金条款** | 图书馆流通部（105 室）**025-85864109** | 🔴 高 |
...
| B4 | **025-85864109（图书馆流通部）是否有人接听**，一并问清 A8 的两件事：学生借阅册数与借期到底是 10 册/30 天还是 30 册/60 天；超期是否收罚金、标准多少 | 一次电话可同时解决 A8 |
...
| D2 | **rerank 实测对比** | working memory 明确"后续可补"，至今未做 |
